...
class Jiagouwu(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Firefox()
        self.driver.implicitly_wait(30)
        self.base_url = "http://release.tao.b5m.com/"
        self.verificationErrors = []
        self.accept_next_alert = True
    
    def test_jiagouwu(self):
        driver = self.driver
